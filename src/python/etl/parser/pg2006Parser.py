...
import PatentZephyr.src.python.etc.parser.schema.pg2006 as schema
...
#
    def getPeople(self,apps,type):
        ...
        for person in apps:
            ...
            persond['nationality'] = self.getXMLPathData(person,'nationality/country')
    ...
    def getParties(self,bib):
        output = list()
        us_applicants = bib.findall('parties/applicants/applicant')
        agents = bib.findall('parties/agents/agent')
        ...
        output += self.getPeople(us_applicants,'applicants')
...
#
    ...
    def getCitations(self,b):
        ...
        for c in b.findall('references-cited/citation'):
