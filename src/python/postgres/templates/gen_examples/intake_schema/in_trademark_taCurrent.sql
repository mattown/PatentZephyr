DROP TABLE IF EXISTS in_trademark_taCurrent ;
CREATE TABLE in_trademark_taCurrent (
...
published_for_opposition_date text,
amend_to_register_date text,
abandonment_date text,
cancellation_code text,
cancellation_date text,
republished_12c_date text,
...
international_publication_date text,
international_renewal_date text,
auto_protection_date text,
international_death_date text,
international_status_code text,
international_status_date text,
priority_claimed_in text,
priority_claimed_date text,
